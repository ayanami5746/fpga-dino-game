...
module dino_obj_motion(
    ...
    output wire [9:0]        cactus_x0,
    output wire [9:0]        cactus_x1,
    output wire [9:0]        cactus_x2,
    output wire [2:0]        cactus_type0,
    output wire [2:0]        cactus_type1,
    output wire [2:0]        cactus_type2,

    output wire [1:0]        ptero_valid,
    output wire [9:0]        ptero_x0,
    output wire [9:0]        ptero_x1,
    ...
    output wire [9:0]        cloud_x0,
    output wire [9:0]        cloud_x1,
    output wire [9:0]        cloud_x2,
